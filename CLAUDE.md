...
The `fable` set covers every article in Book II sequence E ("Overly Convenient Excuses", 10 articles), 49 annotations total; none of these had an Opus set, so `fable` is the only set in their index files. Its targets: the "stronger or weaker" humility criterion as the vague principle the essay itself warns against, and the solitary-astronaut picture of humility against the social machinery of self-correction (bias blind spot, Mercier & Sperber); the Mercury-perihelion and solar-neutrino history against "physicists follow up small flaws"; the Tappin/Druckman prior-confound against diagnosing motivated skepticism from asymmetric scrutiny; the misremembered bribes-vs-praise finding (Deci meta-analysis, Mueller & Dweck), the Santa literature, and Klein/Johnson & Raab "take the first" against "decision-making is a search for alternatives"; the buying-a-dream demand model (Forrest et al.), Oettingen's positive-fantasy findings, prospect-theory probability weighting, and relative-deprivation manipulations against the lottery essays' single-cause stupidity story; Premium Bonds and prize-linked savings as the New Improved Lottery that exists and helps; the 2^750,000,000 figure as a coincidence null nobody holds, and the likelihood/posterior equivocation in the slippery-cliff argument; the continuum fallacy's existing name, the debiasing-measurement objection the Fallacy of Gray strawmans, Fuchs/Javdani on economists' filters, and Farias on lay "faith in science"; the developmental-epistemology finding that "science is probabilistic" moves absolutists into relativism, the van der Bles/Gustafson evidence that admitting uncertainty barely costs trust, and the hard-easy effect against the calibration argument; Quine/Frege and the genetic fallacy against the 2 + 2 = 3 essay; the frequentist "million statements" gloss contradicting the sequence's own subjectivism, the incoherence of 0.9999 credence in a theorem (logical induction), and the hundred-lifetimes arithmetic slip; and regularity's known failures (Shimony, Williamson, Easwaran), Halpern's Cox counterexample, the field-axiom inversion, the loss of Bayes' theorem without normalization, and Popper functions against "0 and 1 are not probabilities".
